...
namespace fdapde {
  namespace r {
    ...
    //      .method("set_external_voronoi_measures"   , &R_DEPTH<1,1>::set_external_voronoi_measures)
    //      .method("set_functional_data"             , &R_DEPTH<1,1>::set_functional_data          )
    //      .method("set_locations"                   , &R_DEPTH<1,1>::set_locations                )
    //      .method("set_roi"                         , &R_DEPTH<1,1>::set_roi                      )
    //      .method("set_depth_types"                 , &R_DEPTH<1,1>::set_depth_types              )
    //      .method("set_int_method"                  , &R_DEPTH<1,1>::set_int_method               )
    ...
    //      .method("f_fit"                           , &R_DEPTH<1,1>::f_fit                        )
    //      .method("f_fit_NA"                        , &R_DEPTH<1,1>::f_fit_NA                     )
    //      .method("f_pred"                          , &R_DEPTH<1,1>::f_pred                       )
    //      .method("f_pred_NA"                       , &R_DEPTH<1,1>::f_pred_NA                    )
    ...
    //      .method("first_quartile_NA"               , &R_DEPTH<1,1>::first_quartile_NA            )
    //	    .method("third_quartile"                  , &R_DEPTH<1,1>::third_quartile               )
    //      .method("third_quartile_NA"               , &R_DEPTH<1,1>::third_quartile_NA            )
    // 	    .method("up_whisker"                      , &R_DEPTH<1,1>::up_whisker                   )
    //      .method("up_whisker_NA"                   , &R_DEPTH<1,1>::up_whisker_NA                )
    //	    .method("low_whisker"                     , &R_DEPTH<1,1>::low_whisker                  )
    //      .method("low_whisker_NA"                  , &R_DEPTH<1,1>::low_whisker_NA               )
    // 	    .method("outliers"                        , &R_DEPTH<1,1>::outliers                     )
    //      .method("int_method"                      , &R_DEPTH<1,1>::int_method                   )
    ...
    //      .method("set_external_voronoi_measures"   , &R_DEPTH<1,2>::set_external_voronoi_measures)
    //      .method("set_functional_data"             , &R_DEPTH<1,2>::set_functional_data          )
    //      .method("set_locations"                   , &R_DEPTH<1,2>::set_locations                )
    //      .method("set_roi"                         , &R_DEPTH<1,2>::set_roi                      )
    //      .method("set_int_method"                  , &R_DEPTH<1,2>::set_int_method               )
    ...
    //      .method("f_fit"                           , &R_DEPTH<1,2>::f_fit                        )
    //      .method("f_fit_NA"                        , &R_DEPTH<1,2>::f_fit_NA                     )
    //      .method("f_pred"                          , &R_DEPTH<1,2>::f_pred                       )
    //      .method("f_pred_NA"                       , &R_DEPTH<1,2>::f_pred_NA                    )
    ...
    //      .method("first_quartile_NA"               , &R_DEPTH<1,2>::first_quartile_NA            )
    //	    .method("third_quartile"                  , &R_DEPTH<1,2>::third_quartile               )
    //      .method("third_quartile_NA"               , &R_DEPTH<1,2>::third_quartile_NA            )
    // 	    .method("up_whisker"                      , &R_DEPTH<1,2>::up_whisker                   )
    //      .method("up_whisker_NA"                   , &R_DEPTH<1,2>::up_whisker_NA                )
    //	    .method("low_whisker"                     , &R_DEPTH<1,2>::low_whisker                  )
    //      .method("low_whisker_NA"                  , &R_DEPTH<1,2>::low_whisker_NA               )
    // 	    .method("outliers"                        , &R_DEPTH<1,2>::outliers                     )
    //      .method("int_method"                      , &R_DEPTH<1,2>::int_method                   )
	...
	.method("set_external_voronoi_measures"   , &R_DEPTH<2,2>::set_external_voronoi_measures)
	.method("set_functional_data"             , &R_DEPTH<2,2>::set_functional_data          )
	.method("set_locations"                   , &R_DEPTH<2,2>::set_locations                )
	.method("set_roi"                         , &R_DEPTH<2,2>::set_roi                      )
	.method("set_depth_types"                 , &R_DEPTH<2,2>::set_depth_types              )
	.method("set_int_method"                  , &R_DEPTH<2,2>::set_int_method               )
	...
	.method("f_fit"                           , &R_DEPTH<2,2>::f_fit                        )
	.method("f_fit_NA"                        , &R_DEPTH<2,2>::f_fit_NA                     )
	.method("f_pred"                          , &R_DEPTH<2,2>::f_pred                       )
	.method("f_pred_NA"                       , &R_DEPTH<2,2>::f_pred_NA                    )
	...
	.method("first_quartile_NA"               , &R_DEPTH<2,2>::first_quartile_NA            )
	.method("third_quartile"                  , &R_DEPTH<2,2>::third_quartile               )
	.method("third_quartile_NA"               , &R_DEPTH<2,2>::third_quartile_NA            )
	.method("up_whisker"                      , &R_DEPTH<2,2>::up_whisker                   )
	.method("up_whisker_NA"                   , &R_DEPTH<2,2>::up_whisker_NA                )
	.method("low_whisker"                     , &R_DEPTH<2,2>::low_whisker                  )
	.method("low_whisker_NA"                  , &R_DEPTH<2,2>::low_whisker_NA               )
	.method("outliers"                        , &R_DEPTH<2,2>::outliers                     )
	.method("int_method"                      , &R_DEPTH<2,2>::int_method                   )
    ...
    RCPP_MODULE(cpp_surface_depth) {
	  ...
	  .method("set_external_voronoi_measures"   , &R_DEPTH<2,3>::set_external_voronoi_measures)
          .method("set_functional_data"             , &R_DEPTH<2,3>::set_functional_data          )
          .method("set_locations"                   , &R_DEPTH<2,3>::set_locations                )
	  .method("set_roi"                         , &R_DEPTH<2,3>::set_roi                      )
          .method("set_depth_types"                 , &R_DEPTH<2,3>::set_depth_types              )
	  .method("set_int_method"                  , &R_DEPTH<2,3>::set_int_method               )
	  ...
	  .method("f_fit"                           , &R_DEPTH<2,3>::f_fit                        )
	  .method("f_fit_NA"                        , &R_DEPTH<2,3>::f_fit_NA                     )
          .method("f_pred"                          , &R_DEPTH<2,3>::f_pred                       )
	  .method("f_pred_NA"                       , &R_DEPTH<2,3>::f_pred_NA                    )
	  ...
	  .method("first_quartile_NA"               , &R_DEPTH<2,3>::first_quartile_NA            )
    	  .method("third_quartile"                  , &R_DEPTH<2,3>::third_quartile               )
	  .method("third_quartile_NA"               , &R_DEPTH<2,3>::third_quartile_NA            )
     	  .method("up_whisker"                      , &R_DEPTH<2,3>::up_whisker                   )
	  .method("up_whisker_NA"                   , &R_DEPTH<2,3>::up_whisker_NA                )
    	  .method("low_whisker"                     , &R_DEPTH<2,3>::low_whisker                  )
	  .method("low_whisker_NA"                  , &R_DEPTH<2,3>::low_whisker_NA               )
     	  .method("outliers"                        , &R_DEPTH<2,3>::outliers                     )
	  .method("int_method"                      , &R_DEPTH<2,3>::int_method                   )
    ...
    RCPP_MODULE(cpp_3d_depth) {
	  ...
	  .method("set_external_voronoi_measures"   , &R_DEPTH<3,3>::set_external_voronoi_measures)
          .method("set_functional_data"             , &R_DEPTH<3,3>::set_functional_data          ) 
          .method("set_locations"                   , &R_DEPTH<3,3>::set_locations                )
	  .method("set_roi"                         , &R_DEPTH<3,3>::set_roi                      )
          .method("set_depth_types"                 , &R_DEPTH<3,3>::set_depth_types              )
	  .method("set_int_method"                  , &R_DEPTH<3,3>::set_int_method               )
	  ...
	  .method("f_fit"                           , &R_DEPTH<3,3>::f_fit                        )
	  .method("f_fit_NA"                        , &R_DEPTH<3,3>::f_fit_NA                     )
          .method("f_pred"                          , &R_DEPTH<3,3>::f_pred                       )
	  .method("f_pred_NA"                       , &R_DEPTH<3,3>::f_pred_NA                    )
	  ...
	  .method("first_quartile_NA"               , &R_DEPTH<3,3>::first_quartile_NA            )
          .method("third_quartile"                  , &R_DEPTH<3,3>::third_quartile               )
	  .method("third_quartile_NA"               , &R_DEPTH<3,3>::third_quartile_NA            )
          .method("up_whisker"                      , &R_DEPTH<3,3>::up_whisker                   )
	  .method("up_whisker_NA"                   , &R_DEPTH<3,3>::up_whisker_NA                )
          .method("low_whisker"                     , &R_DEPTH<3,3>::low_whisker                  )
	  .method("low_whisker_NA"                  , &R_DEPTH<3,3>::low_whisker_NA               )
          .method("outliers"                        , &R_DEPTH<3,3>::outliers                     )
	  .method("int_method"                      , &R_DEPTH<3,3>::int_method                   )
