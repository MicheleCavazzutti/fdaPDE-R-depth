...
namespace fdapde {
  namespace r {
    ...
    //      .method("set_depth_types"                 , &R_DEPTH<1,2>::set_depth_type             )
	...
	.method("set_depth_types"                 , &R_DEPTH<2,2>::set_depth_type             )
    ...
    //      .method("set_depth_types"                 , &R_DEPTH<2,3>::set_depth_type             )
    ...
    //      .method("set_depth_types"                 , &R_DEPTH<3,3>::set_depth_type             )
