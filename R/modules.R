...
# Rcpp::loadModule("cpp_surface_depth",  TRUE) # To be reactivated when recovering 2.5 Triangulation
# Rcpp::loadModule("cpp_3d_depth",       TRUE) # To be reactivated when recovering 3 Triangulation
